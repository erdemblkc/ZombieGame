...
public class ZombieHitReact : MonoBehaviour
{
    ...
    public bool stopAIWhileKnockback = false; // false = AI hi� kapanmaz
    public bool stopAgentWhileKnockback = false; // false = agent hi� durmaz
    ...
    {
        // Stack olmas�n: knockback �al���yorsa yeniden ba�latma
        if (running == null)
    ...
    IEnumerator ReactRoutine(Vector3 attackerPos)
    {
        ...
        // �stersen knockback s�resince AI/agent �ok k�sa kesilebilir (default kapal�)
